...
/***/ function(module, exports, __webpack_require__) {
	...
	var AdminPost = React.createClass({
	  displayName: 'AdminPost',

	  render: function render() {
	    return React.createElement(
	      'form',
	      { action: '/admin/building/new', method: 'post' },
	      React.createElement(AdminControl, null),
	      React.createElement(AdminTitle, null),
	      React.createElement(AdminDescribe, null),
	      React.createElement(AdminSubmit, null)
	    );
	  }
	});

	var AdminControl = React.createClass({
	  displayName: 'AdminControl',

	  render: function render() {
	    return React.createElement('input', { type: 'hidden', name: this.props.id, value: this.props.id });
	  }
	});
	...
	var AdminTitle = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement('input', { type: 'text', name: 'title', id: 'cd-title' })
	    );
	  }
	});

	var AdminDescribe = React.createClass({
	  displayName: 'AdminDescribe',
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement('textarea', { name: 'describe', id: 'cd-describe' })
	    );
	  }
	});

	var AdminSubmit = React.createClass({
	  displayName: 'AdminSubmit',
	...
	module.exports = ReactDOM.render(React.createElement(AdminPost, null), document.getElementById('cd-main'));
